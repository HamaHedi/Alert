...
import ContactForm from '../pages/Alerts/ContactForm';
import PaymentForm from '../pages/Alerts/PaymentForm';
import ServiceForm from '../pages/Alerts/ServiceForm';
import {
  useStripe,
  useElements,
  CardCvcElement
} from '@stripe/react-stripe-js';
import { useStateValue } from '../StateContext/index2';
